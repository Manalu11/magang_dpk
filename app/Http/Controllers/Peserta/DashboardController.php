        ...
        <div class="card border-0 shadow-sm h-100">
            ...
            <div class="card-body">
                ...
                <div class="row g-3">
                    ...
                    <div class="col-6">
                        <div class="p-3 bg-light rounded text-center">
                            ...
                            @if(optional($laporan->pendaftaran->sertifikat)->file_path)
                ...
                <div class="mt-3 d-flex gap-2 flex-wrap">
                    ...
                    @if(optional($laporan->pendaftaran->sertifikat)->file_path)
                    <a href="{{ Storage::url($laporan->pendaftaran->sertifikat->file_path) }}" target="_blank"
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const colors = total > 0 ?
        ['rgba(25,135,84,0.85)', 'rgba(13,202,240,0.85)', 'rgba(255,193,7,0.85)', 'rgba(220,53,69,0.85)'] :
