            ...
            <div class="tab-pane fade show active" id="tab-ikon">
                ...
                <div class="d-flex flex-wrap gap-2">
                    ...
                    <div class="ikon-option text-center" style="cursor:pointer; width:70px;"
                        ...
                        <div class="ikon-box border rounded p-2 d-flex flex-column align-items-center"
                            style="background:#f8f9fa; transition: all .15s;" id="ikon-box-{{ $key }}">
                ...
                <input type="hidden" name="ikon" id="selectedIkon" value="">
            </div>

            {{-- Tab Upload --}}
            <div class="tab-pane fade" id="tab-upload">
                <p class="text-muted small mb-2">Upload gambar thumbnail (jpg, png, webp — maks 2MB):</p>
...
function pilihIkon(key, el) {
    ...
    // Kosongkan file upload jika user switch ke ikon
...
function previewThumbnail(event) {
    ...
    // Reset pilih ikon jika user switch ke upload
    document.querySelectorAll('.ikon-box').forEach(b => {
        b.style.background = '#f8f9fa';
        b.style.borderColor = '';
    });
